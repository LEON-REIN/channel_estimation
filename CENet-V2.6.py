...
x = layers.LayerNormalization(axis=-1)(x)
x = layers.LSTM(32, return_sequences=True, recurrent_initializer='orthogonal')(x)
x = layers.LayerNormalization(axis=-1)(x)
x = layers.LSTM(32, return_sequences=True, recurrent_initializer='orthogonal')(x)
x = layers.LayerNormalization(axis=-1)(x)
...
# Epoch 300:
# acc_of_all: 0.7076 - acc_of_valid: 0.6101
# val_acc_of_all: 0.6719 - val_acc_of_valid: 0.5625
